    ...
    <main>
        <section>
            ...
            <ul>
                ...
                <li><a href="FAQ.php" >FAQ</a></li>
                <li><a href="formRegistroRRHH.php" >Registro</a></li>
                <li><a href="formInhabilitarRRHH.php" >Inhabilitar</a></li>
                <li><a href="formModificarRRHH.php" >Modificar</a></li>
                <li><a href="formConsultarRRHH.php" >Consultar</a></li>
                <li><a href="https://phylo.co/blog/traccion/que-son-los-terminos-y-condiciones/">términos y condiciones (T&C)</a></li>
