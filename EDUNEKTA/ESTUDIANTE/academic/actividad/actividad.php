...
class Actividad {
    ...
    public function actualizar($conexion) {
        $stmt = $conexion->prepare("UPDATE actividad SET titulo=?, fecha=?, descripcion=?, clase_id=?, estado=? WHERE id=?");
...
class ActividadFactory {
    ...
    public function obtenerActividadPorId($id) {
        $stmt = $this->conexion->prepare("SELECT * FROM actividad WHERE id = ?");
    ...
    public function obtenerTodasLasActividades() {
        $result = $this->conexion->query("SELECT * FROM actividad ORDER BY fecha DESC");
        $actividades = [];
    ...
    public function obtenerActividadesPorEstado($estado) {
        $stmt = $this->conexion->prepare("SELECT * FROM actividad WHERE estado = ? ORDER BY fecha DESC");
    ...
    public function obtenerActividadesPorClase($clase_id) {
        $stmt = $this->conexion->prepare("SELECT * FROM actividad WHERE clase_id = ? ORDER BY fecha DESC");
