          ...
          <div class="nav">
            ...
            <div class="collapse" id="collapseActivity" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                ...
                <a class="nav-link" href="academic/actividad/eliminarActividad.php">Eliminar Actividad</a>
              </nav>
            </div>
            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseAsigna"
              aria-expanded="false" aria-controls="collapseAsigna">
              <div class="sb-nav-link-icon">
                <svg class="svg-inline--fa fa-table-columns" aria-hidden="true" focusable="false" data-prefix="fas"
                  data-icon="table-columns" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                  data-fa-i2svg="">
            ...
            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                <nav class="sb-sidenav-menu-nested nav">
                  <a class="nav-link" href="admin/certificados/descargar.php">Descargar Certificado</a>
                </nav>
              </nav>
            </div>
            <div class="sb-sidenav-menu-heading">Comunicación</div>
            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseComuni"
              aria-expanded="false" aria-controls="collapseComuni">
              <div class="sb-nav-link-icon">
                <svg class="svg-inline--fa fa-table-columns" aria-hidden="true" focusable="false" data-prefix="fas"
                  data-icon="table-columns" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                  data-fa-i2svg="">
            ...
            <div class="collapse" id="collapseComuni" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                ...
                <a class="nav-link" href="comunicacion/mensajes.php">Mensaje</a>
                <a class="nav-link" href="comunicacion/notificaciones.php">Notificaciones</a>
