          ...
          <div class="nav">
            ...
            >
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="academic/actividad/crearActividad.html">Crear Actividad</a>
                <a class="nav-link" href="academic/actividad/editarActividad.html">Editar Actividad</a>
                <a class="nav-link" href="academic/actividad/Consultar.html">Consultar Actividad</a>
              </nav>
            </div>
            <a
              class="nav-link collapsed"
            ...
            >
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="academic/actividad/crearAsignatura.html">Crear</a>
                <a class="nav-link" href="academic/actividad/editarAsignatura.html">Editar</a>
                <a class="nav-link" href="academic/actividad/Consultar.html">Consultar
                  >Eliminar</a
                >
              </nav>
            </div>
            <a href="admin/Administracion.html" class="sb-sidenav-menu-heading nav-link">Administracion</a>
            <a
              class="nav-link collapsed"
              href="#"
              data-bs-toggle="collapse"
            ...
            >
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="admin/usuario/registrar.html">Registrar</a>
                <a class="nav-link" href="admin/usuario/consultar.html">Consultar</a>
            ...
            >
              ...
              >
                <nav class="sb-sidenav-menu-nested nav">
                  <a class="nav-link" href="./admin/Certificado.html">Descargar Certificado</a>
                </nav>
              </nav>
            </div>
            ...
            >
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="comunicacion/foro.html">Foro</a>
                <a class="nav-link" href="comunicacion/mensajes.html">Mensaje</a>
                <a class="nav-link" href="comunicacion/notificaciones.html">Notificaciones</a>
                <a class="nav-link" href="comunicacion/noticias.html">Noticias</a>
              </nav>
            </div>
          </div>
        </div>
