      ...
      <ul class="navbar-nav ms-auto">
        <li class="nav-item dropdown">
          <a
            ...
            aria-expanded="false"
            ><svg
              class="svg-inline--fa fa-user fa-fw"
              aria-hidden="true"
              focusable="false"
              data-prefix="fas"
              data-icon="user"
              ...
              <div class="nav">
                ...
                >
                  <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" href="../actividad/crearActividad.php" >Crear</a>
                    <a class="nav-link" href="../actividad/editarActividad.php" >Editar</a>
                    <a class="nav-link" href="../actividad/eliminarActividad.php" >Eliminar</a>
                  </nav>
                </div>
                <a
                  class="nav-link collapsed"
                ...
                >
                  <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" href="crearAsignatura.php" >Crear</a>
                    <a class="nav-link" href="editarAsignatura.php" >Editar</a>
                    <a class="nav-link" href="eliminarAsignatura.php" 
                      >Eliminar</a
                    >
                  </nav>
                </div>
                ...
                >
                  <nav class="sb-sidenav-menu-nested nav">
                    ...
                    <a class="nav-link" href="../../comunicacion/Notificacion.php" 
                      >Notificaciones</a
                    >
                ...
                <div class="card shadow p-4 form-card">
                    <form action="#" method="post" class="needs-validation" novalidate=">
                        <div class="text-center mb-4">
                            ...
                            <h1 class="h4">Crear asignatura</h1>
                        </div>

            
                        <div class="row g-2">
                            <div class="col-md-4">
                                <label for="nombre-completo" class="form-label">Nombre Asignatura</label>
                                <input type="text" id="nombre-completo" name="nombre_completo" class="form-control" required="
                                    placeholder="Nombre de la asignatura">
                                <div class="invalid-feedback">Por favor, ingresa una asignatura .</div>
                            </div>
        
                            <div class="col-md-4">
                                <label for="rol" class="form-label">Grado</label>
                            ...
                            <div class="col-md-4">
                                <label for="rol" class="form-label">Material de estudio</label>
                                <select id="rol" name="rol" class="form-select" required=">
                                    <option value=">Seleccione Material</option>
                                    <option value="Primaria">Teoria de conjunto</option>
                                    <option value="Secundaria">Celulas animales</option>
                                    <option value="Bachillerato">Historia de colombia</option>
                                </select>
                                <div class="invalid-feedback">Por favor, selecciona un material de estudio.</div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <textarea id="competencia" name="competencia" class="form-control" rows="4"
                                    placeholder="Esto debe ser un select de competencias, o un search y select"></textarea>
                            </div>
                        </div>
