                ...
                <div class="container mt-5">
                    <div class="card shadow p-4">
                        ...
                        <ul class="nav nav-tabs" id="settingsTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="profile-photo-tab" data-bs-toggle="tab" data-bs-target="#profile-photo" type="button" role="tab" aria-controls="profile-photo" aria-selected="false">Foto de Perfil</button>
                            </li>
                        </ul>
                        <div class="tab-content mt-4" id="settingsTabContent">
                            ...
                            <div class="tab-pane fade" id="notifications" role="tabpanel" aria-labelledby="notifications-tab">
                                <form action="#" method="post">
                                    <div class="form-check mb-2">
                                        ...
                                        <label class="form-check-label" for="email-notifications">Recibir notificaciones por correo</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="sms-notifications">
                                        <label class="form-check-label" for="sms-notifications">Recibir notificaciones por SMS</label>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="profile-photo" role="tabpanel" aria-labelledby="profile-photo-tab">
                                <form action="#" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                                    <div class="mb-3">
                                        <label for="profile-photo" class="form-label">Subir Foto de Perfil</label>
                                        <input type="file" id="profile-photo" name="profile-photo" class="form-control" accept="image/*" required>
