          ...
          <div class="nav">
            ...
            <div class="collapse" id="collapseComuni" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                ...
                <a class="nav-link" href="./Notificacion.php" >Notificaciones</a>
        ...
        <div class="card shadow p-4">
          <form action="#" method="post" class="needs-validation" novalidate>
            <div class="text-center mb-4">
              <a href="./index.php" ><img src="../imagenes/Logotipo.png" alt="logo" class="logologin mb-3"></a>
            ...
            <div class="mb-3">
              <label for="valor-busqueda" class="form-label">Destinatario</label>
            ...
            <div class="mb-3">
              ...
              <textarea id="motivo" name="motivo" class="form-control" rows="4"
                placeholder="Escriba la descripción dede tu mensaje"></textarea>
            </div>
            ...
            <p class="mt-3 text-muted">*Al eliminar un mensaje no se podrá volver a acceder al él desde el sistema.
              Verifique la información antes de proceder.</p>
          </form>
