      ...
      <ul class="navbar-nav ms-auto">
        <li class="nav-item dropdown">
          ...
          >
            ...
            <li>
              <a class="dropdown-item" href="dashboard.php" #!">Mi Actividad</a>
            </li>
            <li>
        ...
        <div class="container mt-5">
          <div class="card shadow p-4">
            ...
            >
              ...
              <!-- Estado de la Notificación - Opciones-->
              <div class="mb-3">
              ...
              <!-- Tipo (Proviene de) - Origen de la Notificación -->
              <div class="mb-3">
                <label for="tipo_proviene_de" class="form-label">Origen</label>
                <select
                  class="form-select"
                  id="tipo_proviene_de"
                  name="tipo_proviene_de"
                  required
                >
              ...
              <!-- Cuerpo de la notificación que mostrará la interfaz al usuario-->
              <div class="mb-3">
                <label for="cuerpo_notificacion" class="form-label"
                  >Notificación</label
                >
                <textarea
                  class="form-control"
                  id="cuerpo_notificacion"
                  name="cuerpo_notificacion"
                  rows="4"
                  readonly
                >
                                La notificación fue enviada por [Nombre del remitente] a [Nombre del destinatario]. El estado actual es [Estado]. 
                                Fue enviada el [Fecha de envío] y recibida el [Fecha de recepción].
                            </textarea
                >
              </div>
              ...
              <div class="text-center">
                ...
                <button type="reset" class="btn btn-secondary">Guardar</button>
                <button type="submit" class="btn btn-primary">Archivar</button>
              </div>
              <p class="mt-3 text-muted">
                *Al eliminar una notificación esta no se podrá volver a ver en
                el sistema. Verifique la información antes de proceder.
              </p>
            </form>
          </div>
        </div>
          ...
          <div class="container-fluid px-4">
            ...
            >
              <div class="text-muted">
                © 2024 Edunekta. Todos los derechos reservados.
              </div>
              <div>
