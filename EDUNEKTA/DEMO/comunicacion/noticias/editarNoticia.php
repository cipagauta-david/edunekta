            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="dashboard.php" #!">Configuración</a></li>
                        <li><a class="dropdown-item" href="dashboard.php" #!">Mi Actividad</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="dashboard.php" #!">Salir de mi cuenta</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
                  ...
                  <div class="nav">
                    ...
                    >
                      <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="academic/actividad/crearActividad.php" >Crear</a>
                        <a class="nav-link" href="academic/actividad/editarActividad.php" >Editar</a>
                    ...
                    >
                      <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="academic/crearAsignatura.php" >Crear</a>
                        <a class="nav-link" href="academic/editarAsignatura.php" >Editar</a>
                        <a class="nav-link" href="academic/eliminarAsignatura.php" >Eliminar</a
                        >
                      </nav>
                    </div>
                    ...
                    >
                      ...
                      >
                        <nav class="sb-sidenav-menu-nested nav">
                          <a class="nav-link" href="./admin/Certificado.php" 
                    ...
                    <a
                      ...
                      href="dashboard.php" #"
                      data-bs-toggle="collapse"
                      data-bs-target="#collapseComuni"
                      aria-expanded="false"
                      aria-controls="collapseComuni"
                    >
                      <div class="sb-nav-link-icon">
                        <svg
                          class="svg-inline--fa fa-table-columns"
                    ...
                    >
                      <nav class="sb-sidenav-menu-nested nav">
                        ...
                        <!-- PETICIONES PARA NOTICIAS DESPLEGUE PANEL LATERAL -->
                        <div>
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="./crearNoticia.php" >Crear Noticia</a>
                                <a class="nav-link" href="./editarNoticia.php" >Editar Noticia</a>
                                <a class="nav-link" href="./eliminarNoticia.php" >Eliminar Noticia</a>
                                <a class="nav-link" href="./verNoticia.php" >Ver Noticia</a>
                              </nav>
                        </div>
                      </nav>
                    </div>
...
<!-- Bloque form Noticias - Interfaz -->
                <div class="container mt-5">
                    <div class="card shadow p-4">
                        <form action="#" method="POST" class="container mt-4">
                            <h3 class="mb-4">Publicar Nueva Noticia</h3>
                        
                            <!-- Título -->
                            <div class="mb-3">
                                <label for="titulo" class="form-label">Título de la Noticia</label>
                                <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Escribe el título aquí..." required>
                            </div>
                        
                            <!-- Resumen -->
                            <div class="mb-3">
                                <label for="resumen" class="form-label">Resumen</label>
                                <textarea class="form-control" id="resumen" name="resumen" rows="3" placeholder="Breve resumen de la noticia..." required></textarea>
                            </div>
                        
                            <!-- Contenido -->
                            <div class="mb-3">
                                <label for="contenido" class="form-label">Contenido</label>
                                <textarea class="form-control" id="contenido" name="contenido" rows="6" placeholder="Escribe el contenido completo aquí..." required></textarea>
                            </div>
                        
                            <!-- Imagen Por el momento no habilitado -->
                            <!-- <div class="mb-3">
                            ...
                            <p class="mt-3 text-muted">*Al eliminar una noticia esta no se podrá volver a visualizar ni acceder desde el sistema. Verifique la información antes de proceder.</p>
                        </form>
