                  ...
                  <div class="nav">
                    ...
                    >
                      <nav class="sb-sidenav-menu-nested nav">
                        ...
                        <!-- PETICIONES PARA FORO DESPLEGUE PANEL LATERAL -->
                        <div>
                    ...
                    <div class="card shadow p-4">
                        <form action="#" method="post" class="needs-validation" novalidate>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="valor-busqueda" name="valor" class="form-control" required placeholder="Ingrese el título correspondiente al foro">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="motivo" name="motivo" class="form-control" rows="4" placeholder="Escriba la descripción del foro aquí"></textarea>
                            </div>
                            ...
                            <p class="mt-3 text-muted">*Al eliminar un foro este no se podrá volver a acceder al él desde el sistema. Verifique la información antes de proceder.</p>
                        </form>
                    </div>
                </div>
