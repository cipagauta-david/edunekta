                    ...
                    <div class="card shadow p-4">
                        <form action="#" method="get" class="needs-validation" novalidate>
                            <div class="text-center mb-4">
                                ...
                                <h1 class="h4">Certificados</h1>
                            </div>
                            <div class="mb-3">
                                <label for="criterio-busqueda" class="form-label">Tipo de certificado</label>
                                <select id="criterio-busqueda" name="criterio" class="form-select" required>
                                    <option value=">Seleccionar</option>
                                    <option value="nombre">Certificado de matrícula</option>
                                    <option value="cedula">Certificado parcial</option>
                                    <option value="correo">Certificado de estudios</option>
                                    <option value="rol">Acta de grado</option>
                                </select>
