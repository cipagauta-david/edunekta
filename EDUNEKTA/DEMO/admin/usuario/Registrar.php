                ...
                <div class="card shadow p-4 form-card">
                    <form action="procesar.php" method="post" class="needs-validation" novalidate=">
                        <div class="text-center mb-4">
                            ...
                            <h1 class="h4">Registro de Personal RR.HH.</h1>
                        </div>
            
                        <div class="row g-2">
                            <div class="col-md-4">
                                <label for="nombre-completo" class="form-label">Nombre Completo</label>
                                <input type="text" id="nombre-completo" name="nombre_completo" class="form-control" required=" placeholder="Nombre Completo">
                            </div>
            
                            <div class="col-md-4">
                                <label for="cedula" class="form-label">Número Doc Identidad</label>
                                <input type="text" id="cedula" name="cedula" class="form-control" required=" placeholder="Número Doc Identidad">
                            </div>
            
                            <div class="col-md-4">
                                <label for="correo" class="form-label">Correo Electrónico</label>
                                <input type="email" id="correo" name="correo" class="form-control" required=" placeholder="edunekta@correo.com">
                            </div>
            
                            <div class="col-md-4">
                                <label for="telefono" class="form-label">Teléfono</label>
                                <input type="tel" id="telefono" name="telefono" class="form-control" required=" placeholder="Teléfono">
                            </div>
            
                            <div class="col-md-4">
                                <label for="rol" class="form-label">Rol en el colegio</label>
                            ...
                            <div class="col-md-4">
                                ...
                                <textarea id="observaciones" name="observaciones" class="form-control" rows="4" placeholder="Ingrese observaciones adicionales"></textarea>
                            </div>
                        </div>
