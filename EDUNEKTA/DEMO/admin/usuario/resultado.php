                  ...
                  <div class="nav">
                    ...
                    >
                      <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="../academic/crearActividad.php" >Crear</a>
                        <a class="nav-link" href="../academic/editarActividad.php" >Editar</a>
                    ...
                    >
                      <nav class="sb-sidenav-menu-nested nav">
                        ...
                        <a class="nav-link" href="Habilitar.php" >Habilitar</a>
                  ...
                  <div class="modal-dialog">
                    <form id="formEditar" class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="mb-3"><label>Nombre</label><input type="text" id="edit_nombre" class="form-control" required></div>
                        <div class="mb-3"><label>Cédula</label><input type="text" id="edit_cedula" class="form-control" required></div>
                        <div class="mb-3"><label>Correo</label><input type="email" id="edit_correo" class="form-control" required></div>
                        <div class="mb-3"><label>Rol</label><input type="text" id="edit_rol" class="form-control" required></div>
                        <div class="mb-3">
                          <label>Estado</label>
                ...
                <footer class="py-4 bg-light mt-auto">
                  <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                      <div class="text-muted">Copyright © Tu Sitio 2025</div>
                      <div>
      ...
      tr.innerHTML = `
        ...
        <td>
          <button class="btn btn-warning btn-sm" 
            onclick="mostrarEditar(${fila.id}, '${fila.nombre_completo.replace(/'/g, "\\'")}', '${fila.cedula}', '${fila.correo}', '${fila.rol}', '${fila.estado}')">
            Editar
          </button>
          <button class="btn btn-danger btn-sm" onclick="eliminar(${fila.id})">Eliminar</button>
        </td>
      `;
...
function mostrarEditar(id, nombre, cedula, correo, rol, estado) {
