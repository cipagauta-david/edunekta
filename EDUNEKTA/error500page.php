...
<body>
    ...
    <div style="width: 80%; align-self: center; margin-bottom: 200px;">
        <header>
            <h1>Error 500</h1>
        </header>
        <main>
            <h2>¡Algo salió mal!</h2>
            <p>Parece que hubo un problema en nuestro servidor. Estamos trabajando para solucionarlo.</p>
            <p>Por favor, intenta nuevamente más tarde o regresa a la página principal.</p>
