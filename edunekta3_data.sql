...
INSERT INTO rol (id, nombre, slug, descripcion, activo, created_at)
VALUES
  (1, 'ADMIN', 'admin', 'Administrador del sistema', TRUE, '2024-01-01 00:00:00'),
  (2, 'PROFESOR', 'profesor', 'Personal docente', TRUE, '2024-01-01 00:00:00'),
  (3, 'ESTUDIANTE', 'estudiante', 'Estudiantes', TRUE, '2024-01-01 00:00:00'),
  (4, 'ACUDIENTE', 'acudiente', 'Padres o acudientes', TRUE, '2024-01-01 00:00:00');

-- 2) Seed de permisos (ejemplos; modifica según necesites)
INSERT INTO permiso (id, nombre, slug, descripcion, recurso, accion, activo, created_at)
VALUES
  (1, 'Administrar usuarios', 'admin_users', 'Crear/editar/eliminar usuarios', 'usuario', 'manage', TRUE, '2024-01-01 00:00:00'),
  (2, 'Ver estudiantes', 'view_students', 'Permite ver información de estudiantes', 'usuario', 'view', TRUE, '2024-01-01 00:00:00'),
  (3, 'Gestionar roles', 'manage_roles', 'Crear/editar roles y permisos', 'rol', 'manage', TRUE, '2024-01-01 00:00:00'),
  (4, 'Ver reportes', 'view_reports', 'Acceso a reportes académicos', 'reporte', 'view', TRUE, '2024-01-01 00:00:00');

-- 3) Asignación de permisos a roles (ejemplo)
INSERT INTO rol_permiso (rol_id, permiso_id, created_at)
VALUES
  -- ADMIN: todos los permisos
  (1, 1, '2024-01-01 00:00:00'),
  (1, 2, '2024-01-01 00:00:00'),
  (1, 3, '2024-01-01 00:00:00'),
  (1, 4, '2024-01-01 00:00:00'),

  -- PROFESOR: ver estudiantes y reportes
  (2, 2, '2024-01-10 08:00:00'),
  (2, 4, '2024-01-10 08:00:00'),

  -- ACUDIENTE: ver estudiantes (su propio grupo)
  (4, 2, '2024-02-15 09:05:00');

-- 4) Insertar usuarios (sin columna "rol", que ahora está normalizada en usuario_rol)
INSERT INTO usuario
  (id, institucion_id, nombre, apellido, email, password_hash, tipo_documento, documento, genero, fecha_nacimiento, telefono, direccion, activo, email_verificado, created_at)
VALUES
  (1, 1, 'Carlos', 'Gómez', 'c.gomez@c-sanjose.edu.co', 'hash_prof_1', 'CC', '800111222', 'M', '1985-05-12', '+57 3001110001', 'Calle Maestro 1', TRUE, TRUE, '2024-01-10 08:00:00'),
  (2, 1, 'Sofía', 'Martínez', 's.martinez@c-sanjose.edu.co', 'hash_est_1', 'CC', '100111222', 'F', '2012-03-22', '+57 3002220002', 'Calle Estudiante 2', TRUE, TRUE, '2024-02-15 09:00:00'),
  (3, 1, 'Luis', 'Martínez', 'l.martinez@c-sanjose.edu.co', 'hash_acu_1', 'CC', '700111222', 'M', '1980-11-20', '+57 3003330003', 'Calle Padre 3', TRUE, TRUE, '2024-02-15 09:05:00'),
  (4, 1, 'Ana', 'López', 'a.lopez@c-sanjose.edu.co', 'hash_prof_2', 'CC', '800222333', 'F', '1990-08-02', '+57 3004440004', 'Calle Profesora 4', TRUE, TRUE, '2024-03-01 10:00:00'),
  (5, 1, 'Diego', 'Pérez', 'd.perez@c-sanjose.edu.co', 'hash_est_2', 'CC', '102222333', 'M', '2011-06-30', '+57 3005550005', 'Calle Estudiante 5', TRUE, TRUE, '2024-03-05 11:00:00'),
  (6, 1, 'María', 'Pérez', 'm.perez@c-sanjose.edu.co', 'hash_acu_2', 'CC', '702222333', 'F', '1982-01-18', '+57 3006660006', 'Calle Madre 6', TRUE, TRUE, '2024-03-05 11:05:00'),
  (7, 1, 'Admin', 'Principal', 'admin@c-sanjose.edu.co', 'hash_admin', 'CC', '900000001', 'O', '1975-09-01', '+57 3007770007', 'Oficina Principal', TRUE, TRUE, '2024-01-01 07:00:00'),
  (8, 1, 'Miguel', 'Rodríguez', 'm.rodriguez@c-sanjose.edu.co', 'hash_est_3', 'CC', '103333444', 'M', '2010-12-10', '+57 3008880008', 'Barrio 8', TRUE, TRUE, '2024-04-01 12:00:00'),
  (9, 1, 'Sandra', 'Rodríguez', 's.rodriguez@c-sanjose.edu.co', 'hash_acu_3', 'CC', '703333444', 'F', '1978-07-07', '+57 3009990009', 'Barrio 9', TRUE, TRUE, '2024-04-01 12:05:00'),
  (10, 1, 'José', 'Herrera', 'j.herrera@c-sanjose.edu.co', 'hash_prof_tech1', 'CC', '801010101', 'M', '1982-04-10', '+57 3101001010', 'Laboratorio 1', TRUE, TRUE, '2024-06-01 08:00:00'),
  (11, 1, 'Laura', 'Ruiz', 'l.ruiz@c-sanjose.edu.co', 'hash_prof_tech2', 'CC', '801020202', 'F', '1987-09-21', '+57 3102002020', 'Laboratorio 2', TRUE, TRUE, '2024-06-02 08:30:00'),
  (12, 1, 'Andrés', 'Gómez', 'andres.gomez@c-sanjose.edu.co', 'hash_est_tech_1', 'CC', '110110110', 'M', '2006-02-14', '+57 3200000012', 'Barrio Tech 12', TRUE, TRUE, '2024-07-01 09:00:00'),
  (13, 1, 'Camila', 'Santos', 'camila.santos@c-sanjose.edu.co', 'hash_est_tech_2', 'CC', '110110111', 'F', '2006-05-20', '+57 3200000013', 'Barrio Tech 13', TRUE, TRUE, '2024-07-02 09:10:00'),
  (14, 1, 'Jhon', 'Velásquez', 'jhon.velasquez@c-sanjose.edu.co', 'hash_est_tech_3', 'CC', '110110112', 'M', '2005-11-03', '+57 3200000014', 'Barrio Tech 14', TRUE, TRUE, '2024-07-03 09:20:00'),
  (15, 1, 'Natalia', 'Rueda', 'natalia.rueda@c-sanjose.edu.co', 'hash_est_tech_4', 'CC', '110110113', 'F', '2006-08-11', '+57 3200000015', 'Barrio Tech 15', TRUE, TRUE, '2024-07-04 09:30:00'),
  (16, 1, 'Rafael', 'Gómez', 'rafael.gomez@familias.edu.co', 'hash_acu_tech_1', 'CC', '720110110', 'M', '1978-01-05', '+57 3201000016', 'Calle Padre 16', TRUE, TRUE, '2024-07-05 10:00:00'),
  (17, 1, 'Isabel', 'Santos', 'isabel.santos@familias.edu.co', 'hash_acu_tech_2', 'CC', '720110111', 'F', '1980-04-10', '+57 3201000017', 'Calle Madre 17', TRUE, TRUE, '2024-07-05 10:05:00'),
  (18, 1, 'Marcos', 'Velasquez', 'marcos.velasquez@familias.edu.co', 'hash_acu_tech_3', 'CC', '720110112', 'M', '1975-09-09', '+57 3201000018', 'Calle Padre 18', TRUE, TRUE, '2024-07-05 10:10:00'),
  (19, 1, 'Patricia', 'Rueda', 'patricia.rueda@familias.edu.co', 'hash_acu_tech_4', 'CC', '720110113', 'F', '1979-12-12', '+57 3201000019', 'Calle Madre 19', TRUE, TRUE, '2024-07-05 10:15:00');

-- 5) Asignar roles a los usuarios en el pivot usuario_rol
INSERT INTO usuario_rol (usuario_id, rol_id, asignado_por, created_at)
VALUES
  (1,  2, 7, '2024-01-10 08:00:00'), -- Carlos -> PROFESOR
  (2,  3, 7, '2024-02-15 09:00:00'), -- Sofía -> ESTUDIANTE
  (3,  4, 7, '2024-02-15 09:05:00'), -- Luis -> ACUDIENTE
  (4,  2, 7, '2024-03-01 10:00:00'), -- Ana -> PROFESOR
  (5,  3, 7, '2024-03-05 11:00:00'), -- Diego -> ESTUDIANTE
  (6,  4, 7, '2024-03-05 11:05:00'), -- María -> ACUDIENTE
  (7,  1, NULL, '2024-01-01 07:00:00'), -- Admin -> ADMIN (asignado por NULL)
  (8,  3, 7, '2024-04-01 12:00:00'), -- Miguel -> ESTUDIANTE
  (9,  4, 7, '2024-04-01 12:05:00'), -- Sandra -> ACUDIENTE
  (10, 2, 7, '2024-06-01 08:00:00'), -- José -> PROFESOR
  (11, 2, 7, '2024-06-02 08:30:00'), -- Laura -> PROFESOR
  (12, 3, 7, '2024-07-01 09:00:00'), -- Andrés -> ESTUDIANTE
  (13, 3, 7, '2024-07-02 09:10:00'), -- Camila -> ESTUDIANTE
  (14, 3, 7, '2024-07-03 09:20:00'), -- Jhon -> ESTUDIANTE
  (15, 3, 7, '2024-07-04 09:30:00'), -- Natalia -> ESTUDIANTE
  (16, 4, 7, '2024-07-05 10:00:00'), -- Rafael -> ACUDIENTE
  (17, 4, 7, '2024-07-05 10:05:00'), -- Isabel -> ACUDIENTE
  (18, 4, 7, '2024-07-05 10:10:00'), -- Marcos -> ACUDIENTE
  (19, 4, 7, '2024-07-05 10:15:00'); -- Patricia -> ACUDIENTE
